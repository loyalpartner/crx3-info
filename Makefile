...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/loyalpartner/crx3-info/constant.Version=$(VERSION)" \
		-X "github.com/loyalpartner/crx3-info/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
